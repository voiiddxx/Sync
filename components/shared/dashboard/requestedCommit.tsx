import { AdjustmentsHorizontalIcon, CodeBracketIcon, DocumentDuplicateIcon, HashtagIcon, PencilIcon, PlusCircleIcon, QueueListIcon } from "@heroicons/react/24/solid";
import {
  DotsHorizontalIcon,
  DotsVerticalIcon,
  GitHubLogoIcon,
                    ...
                    <PopoverContent className="w-52" >
                        <div className=" flex flex-col w-full h-full" >
                          ...
                          <div className=" w-full items-center flex gap-2 hover:bg-zinc-50 py-2 px-2 cursor-pointer hover:rounded-md" >
                            ...
                            <p className="text-[13px] font-Poppins " >Overiview</p>
                          </div>
                          <div className=" w-full items-center flex gap-2 hover:bg-zinc-50 py-2 px-2 cursor-pointer hover:rounded-md" >
                            <PencilIcon className="size-4" />
                            <p className="text-[13px] font-Poppins " >Edit commit</p>
                          </div>
                          <div className=" w-full items-center flex gap-2 hover:bg-zinc-50 py-2 px-2 cursor-pointer hover:rounded-md" >
                            <DocumentDuplicateIcon className="size-4" />
                            <p className="text-[13px] font-Poppins " >2 file changes</p>
                          </div>
                          <div className=" w-full items-center flex gap-2 hover:bg-zinc-50 py-2 px-2 cursor-pointer hover:rounded-md" >
                            <PlusCircleIcon className="size-4" />
                            <p className="text-[13px] font-Poppins " >Add message</p>
                          </div>
                          </div>
