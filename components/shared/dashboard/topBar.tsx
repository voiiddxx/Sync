          ...
          <Popover>
            ...
            <PopoverContent className="w-[290px] border mr-10 font-Poppins p-0 bg-[#1f1f21] text-[#DDDDDD] rounded-lg shadow-lg animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 duration-200">
              ...
              <div className="py-2 border-b border-[#2a2a2a]">
                <Button
                  variant="ghost"
                  className="w-full justify-start text-[13px] hover:text-white hover:bg-[#444444] text-white/50 rounded-none"
                >
                ...
                <Button
                  variant="ghost"
                  className="w-full justify-start text-[13px] hover:bg-[#444444] rounded-none text-white/50 hover:text-white"
                >
                ...
                <Button
                  variant="ghost"
                  className="w-full justify-start text-[13px] hover:text-white hover:bg-[#2f2f2f] rounded-none text-white/50"
                >
              ...
              <div className="py-2">
                <p className="px-4 py-1 text-[10px] font-semibold text-[#AAAAAA] uppercase">
                  Switch Account
                </p>
                <div className="flex gap-4 mt-2 flex-col">
                  {["voiiddxx", "astro.tsx"].map((name, index) => (
                    <Button
                      key={name}
                      variant="ghost"
                      className="w-full py-4    justify-start text-[13px] hover:text-white hover:bg-[#444444] rounded-none"
                    >
              ...
              <div className="p-2">
                <Button
                  variant="secondary"
                  className="w-full bg-[#2c2c2e] border border-white/10 hover:bg-[#555555] text-[#DDDDDD]"
                >
                  <p className=" font-normal text-xs tracking-tight">
